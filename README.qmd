...
-   Tarayıcıların, PACS depolarının ve arayüzlerin birbiri ile uyumu oldukça önemlidir.
    ICC profillerinin [^6] [^7] uyumu görüntülerin son kullanıcı olan patolog tarafından değerlendirmesinde önem taşımaktadır
    .
...
# Biyoistatistik Çalışmaları için Veri Hazırlama

Klinikopatolojik çalışmalarda veri hazırlama aşaması oldukça önemlidir:
- Veri ne kadar temiz olursa analiz o kadar hızlı olur. 
- Analiz ne kadar hızlı olursa biyoistatistik uzmanı size o akdar fazla zaman ayırır. 

## Temiz Veri

## Veriyi Nerede Hazırlamalı?
...
### Biyopsi/Tanı/Cerrahi Tarihi

### Ana Tanı (Line Diagnosis)

### Yapılan İşlem (Ameliyat Şekli)
...
### Venöz İnvazyon
Ektramural/İntramural 



### Perinöryal İnvazyon
Ekstramural/İntramural 
...
### Bölgesel Lenf Nodları (Toplam sayı)
