...
Çok modlu bir üretken yapay zeka modeli olan "PathChat 2"[^8] de patolojiye özel bir chatGPT[^9] olarak hayatımızda yer almaya aday modellerdendir
.
...
Open Source Software for Control and Automation of Microscope Hardware [^11]
